                                        ...
                                        ?>
                                            ...
                                            <div class="col-md-2" style="display: flex;justify-content: space-between;">
                                                <label style="width: 100%;display: flex;justify-content: center;align-items: center;">
                                                    {{$value['size']}}
                                                    <!-- <input type="radio" name="selected_size" class="form-control checkbox_size checkbox_{{$value['size']}}" value="{{$value['size']}}" style="width: 20px;" />  -->
                                                </label>
                                            </div>
                                        <?php
                                ...
                                <div class="size_value attr_size" id="attribute_color">
                                    <?php
                                        ...
                                        foreach($all_selected_variatns as $key1=>$value1)
                                        {
                                            ...
                                            {
                                                ?>
                                                    <input type="radio" name="selected_color" value="{{$value1['color_code']}}" class="checkbox_color checkbox-round" style="background-color:{{$value1['color_code']}};" color_code="{{$value1['color_code']}}" variant_id="{{$value1['id']}}" />
                                                <?php
